...
final class CreateNewAppointmentViewController: UIViewController, UIGestureRecognizerDelegate, NSFetchedResultsControllerDelegate {
    
    private var viewModel: CreateAppointmentViewModelProtocol!
...
extension CreateNewAppointmentViewController {
    
    func setupNavigationBar() {
        navigationItem.title = localized(of: .newAppointment)
...
extension CreateNewAppointmentViewController: UICalendarViewDelegate {
...
extension CreateNewAppointmentViewController: UICalendarSelectionSingleDateDelegate {
...
extension CreateNewAppointmentViewController: UITextViewDelegate {
...
extension CreateNewAppointmentViewController: UITextFieldDelegate {
...
extension CreateNewAppointmentViewController: UIContextMenuInteractionDelegate {
